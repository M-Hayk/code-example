...
export const MachineListItemTransportationTemplate = ({
  translations,
  machineItem: {
    id,
    brand,
      ...
      <InfoRow>
        <IconsWithInfoWrapper>
          ...
          <IconWithInfo>
            ...
            <Text variant="Subtitle 1" color="blackMediumEmphasis">
              {meterReadOut
                ? `${meterReadOut?.toLocaleString(CONSTANTS.LOCALE)} km`
                : null}
            </Text>
          </IconWithInfo>
          <IconWithInfo>
...
MachineListItemTransportationTemplate.defaultProps = {
  user: null,
}

MachineListItemTransportationTemplate.propTypes = {
