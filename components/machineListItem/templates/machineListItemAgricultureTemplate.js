...
import { Checkbox, Spacing, Text, Field, StatusText } from "components"
import { CONSTANTS } from "config"

import { CalendarIcon, KeyIcon, TeardropIcon, GearsIcon } from "images"
...
export const MachineListItemAgricultureTemplate = ({
  translations,
  machineItem: {
    id,
    vinCode,
      ...
      <InfoRow>
        <IconsWithInfoWrapper>
          ...
          <IconWithInfo>
            ...
            <Text variant="Subtitle 1" color="blackMediumEmphasis">
              {workHours
                ? `${workHours?.toLocaleString(CONSTANTS.LOCALE)} h`
                : null}
            </Text>
          </IconWithInfo>
          <IconWithInfo>
...
MachineListItemAgricultureTemplate.defaultProps = {
  user: null,
}

MachineListItemAgricultureTemplate.propTypes = {
